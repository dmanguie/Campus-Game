...
public class InteriorSceneRegistry {
    ...
    /** Returns all registered scene IDs — used by the editor scene picker. */
    ...
    private InteriorScene buildLibrary() {
        InteriorScene s = new InteriorScene(
                "library_interior", "University Library",
        ...
        EntranceData exit = new EntranceData(
                "library_exit", "University Library", "University Library",
                420f, 570f, null, 0f, 0f, 0f, 0f);
    ...
    private InteriorScene buildMainHall() {
        InteriorScene s = new InteriorScene(
                "main_hall_interior", "Main Administration Hall",
        ...
        EntranceData exit = new EntranceData(
                "main_hall_exit", "Main Administration Hall", "Main Hall",
                510f, 660f, null, 0f, 0f, 0f, 0f);
    ...
    private InteriorScene buildGym() {
        ...
        EntranceData exit = new EntranceData(
                "gym_exit", "Sports Complex", "Sports Complex",
                460f, 660f, null, 0f, 0f, 0f, 0f);
    ...
    private InteriorScene buildSalBldg() {
        ...
        s.addRoom(new InteriorRoom("hallway_gf", "Ground Floor Hallway",
                40, 40, 800, 140,
                new Color(220, 215, 205), new Color(100, 85, 70)));

        // Classrooms left side
        s.addRoom(new InteriorRoom("room_101", "Room 101",
                40, 200, 360, 180,
                new Color(215, 208, 196), new Color(100, 85, 70)));
        ...
        // Exit near bottom centre
        EntranceData exit = new EntranceData(
                "sal_exit", "SAL Building", "SAL Building",
                440f, 645f, null, 0f, 0f, 0f, 0f);
        exit.triggerRadius = 55f;
        s.addExit(exit);
        return s;
    }
